...
public class RollerIOSpark implements RollerIO {
  ...
  public RollerIOSpark() {
    leftMotor = new SparkMax(RollerConstants.leftCanId, MotorType.kBrushless);
    rightMotor = new SparkMax(RollerConstants.rightCanId, MotorType.kBrushless);
    encoder = leftMotor.getEncoder();

    SparkMaxConfig leftMotorConfig = new SparkMaxConfig();
    leftMotorConfig
        .inverted(RollerConstants.leftMotorInverted)
    ...
    leftMotorConfig
        ...
        .uvwAverageDepth(2)
        .positionConversionFactor(RollerConstants.positionConversionFactor)
        .velocityConversionFactor(RollerConstants.velocityConversionFactor);
    leftMotorConfig
        .signals
    ...
    SparkBaseConfig rightMotorConfig =
        leftMotorConfig.follow(leftMotor, RollerConstants.motorsOppositeDirections);
    tryUntilOk(
        rightMotor,
        5,
        () ->
