...
public class ExtensionConstants {
  ...
  public static final double armOffsetToHorizontalRadians = Units.degreesToRadians(0.0);
  ...
  public static final double maxVelocityRadiansPerSecond = 4.0;
  ...
  public static final double positionToleranceRadians = Units.degreesToRadians(2.0);
