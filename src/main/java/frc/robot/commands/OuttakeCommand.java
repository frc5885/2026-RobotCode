...
public class OuttakeCommand extends Command {
  ...
  @Override
  public void execute() {
    intakeSubsystem.setIntakeRollerVoltage(outtakeRollerVoltage);
    hopperSubsystem.setKickerVoltage(reverseKickerVoltage);
    hopperSubsystem.setSpindexerVoltage(reverseSpindexerVoltage);
  }

  // Called once the command ends or is interrupted.
  @Override
  public void end(boolean interrupted) {
    intakeSubsystem.setIntakeRollerVoltage(0.0);
